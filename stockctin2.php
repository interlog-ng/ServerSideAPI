...
SELECT fmcg_inventory.*, users.username, users.id FROM fmcg_inventory LEFT JOIN `users` ON fmcg_inventory.userID = users.id WHERE entryDate LIKE '2021%' ORDER BY userID";
